  ...
  return (
    <main>
      ...
      <section className="pb-[70px]">
        <Container>
          {/* Hero Image */}
          <div className="relative w-full aspect-21/12 rounded-2xl overflow-hidden group mb-10 md:mb-14">
            <Image
              src={
                post.bannerImage ||
                post.previewImage ||
          ...
          {/* Two-column: sticky meta left, content right */}
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 xl:gap-16 items-start">
            {/* Left: sticky title / date / meta */}
            <aside className="w-full lg:w-[34%] lg:sticky lg:top-28 lg:self-start">
              <div className="bg-warning-light rounded-[24px] p-6 sm:p-8 shadow-sm">
                <p className="text-sm font-bold font-dm-sans tracking-[0.15em] uppercase text-primary mb-3">
                  {post.category?.name || "Uncategorized"}
                </p>

                <h1 className="text-2xl md:text-3xl font-bold font-urbanist text-light-primary-text leading-snug mb-6">
                  {post.title}
                </h1>

                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-x-2 text-light-secondary-text font-medium text-sm">
