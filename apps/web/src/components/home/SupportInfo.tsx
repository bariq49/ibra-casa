...
const SupportInfo = () => {
  return (
    <section className="w-full py-10 md:py-12">
      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 xl:gap-6 w-full"
      ...
      >
        {SUPPORT_ITEMS.map((item, i) => (
          <motion.div
            key={i}
            className="flex flex-col items-center justify-center gap-3 lg:gap-4 bg-white border border-gray-300 rounded-2xl p-6 lg:p-4 xl:p-6 w-full h-full"
