                ...
                <div className="bg-linear-to-br from-green-50 to-emerald-50 border border-success-lighter rounded-lg p-6 shadow-sm">
                  ...
                  <div className="mt-4">
                    <p className="text-4xl font-bold text-success-dark">
                      {formatCurrency(accountsStats?.totalReceived || 0)}
                    </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-orange-700">
                        {formatCurrency(accountsStats?.totalPending || 0)}
                      </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-purple-700">
                        {formatCurrency(
                          pendingSubmissions.reduce((sum, s) => sum + s.amount, 0),
                        )}
                      </p>
                      <p className="text-xs text-grey-500">
                      ...
                      {selectedOrder.items?.map((item, index) => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                            ...
                            <div>
                              <Label>Total Price ({getCurrencySymbol()})</Label>
                              <Input
                                type="number"
                                step="0.01"
                                value={(
